...
import { ClaimsComponent } from '../../components/table-views/claims/claims.component';
import { ClaimspermonthComponent } from '../../components/table-views/claimspermonth/claimspermonth.component';
import { InoutnetworkComponent } from '../../components/table-views/inoutnetwork/inoutnetwork.component';
import { PopulationComponent } from '../../components/table-views/population/population.component';
import { ClaimsdistributionComponent } from "../../components/table-views/claimsdistribution/claimsdistribution.component";
import { Top10conditionsComponent } from "../../components/table-views/top10conditions/top10conditions.component";
import { Top10ProvidersComponent } from '../../components/table-views/top10providers/top10providers.component';
import jsPDF from 'jspdf';
import html2canvas from 'html2canvas';
import PptxGenJS from 'pptxgenjs';
import { ClaimspermembershiptypeComponent } from '../../components/table-views/claimspermembershiptype/claimspermembershiptype.component';
...
async downloadPowerPoint() {
  ...
  const sectionIds = [
    ...
    { id: 'Claims - Top 10 preferred providers (IP + OP)'},
